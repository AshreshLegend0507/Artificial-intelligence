...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            #Get key landmarks
            thumb_tip = hand_landmarks.landmark[mp_hands.Hand Landmark.THUMB_TIP]
            ...
            middle_x, middle_y = int(middle_tip.x frame_width), int(middle_tip.yframe_height)
            ...
            if abs (thumb_x index_x) < 30 and abs (thumb_yindex_y) < 30:
